(function ($, undefined) {
  $.widget('ui.multiselect', {
    ...
    options: {
      ...
      displayTextSG:       '1 de ## valores seleccionados',
      displayTextPL:       '@@ de ## valores seleccionados',
      trivialSeperator:    ', ',
      resetButtonText:     'Reestablecer filtro',
      filterLabelText:     'Filtrar',
      bulkAllText:         'Seleccionar todo',
      bulkNoneText:        'Deseleccionar todo',
